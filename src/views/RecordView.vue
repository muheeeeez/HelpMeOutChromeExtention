<template>
  <div class="main-container">
    <div class="header">
      <div id="app">
        <div class="title">
          ...
          <h1 class="title-text">HelpMeOut</h1>
        </div>
        <div class="icon">
          <img
    ...
    <div v-else>
      <p>Please log in to record videos.</p>
    </div>
    <div v-if="authStore.user">
        ...
        >
          <div class="modal">
            ...
            <div class="modal-actions">
              <button class="btn-primary" @click="confirmRecording">
                Confirm
              </button>
      ...
      <!-- Optionally, show upload progress, etc. -->
      <div v-if="recordingState === 'complete'">
        <p>Upload complete!</p>
      </div>
      <div v-if="recordingState === 'error'">
        <p>Error occurred during recording/upload.</p>
      </div>
    </div>
  </div>
</template>
...
const videoTitle = ref("Recording");
...
function confirmRecording() {
  ...
  const recorderURL =
    ...
    "?videoName=" +
    encodeURIComponent(videoTitle.value);
...
onMounted(() => {
  ...
  if (
    ...
    chrome.runtime.onMessage.addListener((message) => {
      console.log("RecordView received message:", message);
      switch (message.action) {
        case "RECORDING_STARTED":
          recordingState.value = "recording";
          break;
        case "UPLOAD_PROGRESS":
          // You can update a progress bar here if desired.
          break;
        case "UPLOAD_COMPLETE":
          recordingState.value = "complete";
          break;
